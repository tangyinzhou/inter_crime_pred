...
for round in range(1, 101):
    if round % 10 == 0:
        ...
        gnn_weight += 0.1
    gnn_train_dataset = llm_pred_func(llm_train_dataset, llm_prompt_weight, adj, use_dataset, year, city_dict, openai_key)
    gnn_val_dataset = llm_pred_func(llm_val_dataset, llm_prompt_weight, adj, use_dataset, year, city_dict, openai_key)
    gnn_test_dataset = llm_pred_func(llm_test_dataset, llm_prompt_weight, adj, use_dataset, year, city_dict, openai_key)
