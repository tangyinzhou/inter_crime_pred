...
for round in range(1, 101):
    ...
    llm_train_dataset = gnn_pred_func(gnn_train_dataset, trained_GNN, G)
    llm_val_dataset = gnn_pred_func(gnn_val_dataset, trained_GNN, G)
    llm_test_dataset = gnn_pred_func(gnn_test_dataset, trained_GNN, G)
